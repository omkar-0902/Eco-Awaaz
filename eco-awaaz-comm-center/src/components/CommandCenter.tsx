...
const CommandCenter: React.FC = () => {
  ...
  return (
    <>
      <section id="command-center" className="py-24 px-4 sm:px-6 lg:px-8 max-w-[1600px] mx-auto overflow-hidden">
        <div className="mb-16 flex flex-col items-start text-left">
          <span className="text-slate-900 font-bold mb-4 block uppercase font-mono tracking-[0.3em] text-base md:text-lg">01 · Command Center</span>
